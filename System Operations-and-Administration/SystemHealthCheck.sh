...
# Date: 6/30/2024
# Description: This script performs a comprehensive system health check, including CPU usage,
# memory usage, disk usage, network latency, and running services status.
